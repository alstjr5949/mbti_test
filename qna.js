...
const results = {
  ...
  ISFP : {
    ...
    feature : "<span>✂︎</span>사람들 만나는 거 좋은데 싫어요. <br><br> <span>✂︎</span>침대와 물아일체 침대 뿐만 아니라 등을 붙일 곳이 있다면 어디든 누워있어요. <br><br> <span>✂︎</span>거절을 잘 하지 못하는 순둥이에요. <br><br> <span>✂︎</span>집착하는 것은 절대!! 극도로 싫어해요. <br><br> <span>✂︎</span>예술적인 감각이 있어요 <br><br> <span>✂︎</span>칭찬 해주면 마음이 녹아내려요.",
    good : "GOOD : ESTJ, ESFJ",
